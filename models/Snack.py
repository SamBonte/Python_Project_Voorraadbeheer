...
class Snack:
    ...
    def __init__(self, unique_id, name, unit_price, quantity, expiration_date):
        ...
        # Controle op unit_price
        if type(unit_price) in [int, float] and unit_price > 0:
            self._unit_price = round(unit_price, 2)
        else:
            print("Invalid value for: unit_price. Must be a positive number.")
            sys.exit(-1)
